...
public class GeometryLineStringTest {
    ...
    public void setUp() throws Exception {
        ...
        assertTrue(this.dataAssets.get(0) instanceof GeometryLineString );
    ...
    public void getIdentifier() {
        ...
        assertEquals(this.dataAssets.get(0).getIdentifier(),"LS-0" );
    }

    @Test
    public void setCoordinates() {

        GeometryMultiPoint obj = new GeometryMultiPoint("LS-55");
        ...
        assertEquals(this.dataAssets.get(3).getIdentifier(), "LS-55");
